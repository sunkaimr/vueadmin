<template>
  <imp-panel>
    ...
    <div slot="body">
      ...
      <el-dialog title="修改集群信息" :visible.sync="dialogEditFormVisible" :close-on-click-modal="false" style="width: 100%;">
        <el-form size="mini" :model="form" :rules="rules" ref="form">
          <el-form-item label="集群名称" prop="cluster_name" label-width="80px">
            <el-input v-model="form.cluster_name" autocomplete="off" clearable/>
          </el-form-item>
      ...
      <el-table
        ...
        <el-table-column prop="cluster_name" label="集群名称" align="center"  min-width="150px" sortable> </el-table-column>
...
<!--        <el-table-column prop="cluster_type" label="集群类型" align="center" width="100px" sortable></el-table-column>-->
        <el-table-column prop="service_addr" label="服务地址" align="center" min-width="150px" sortable></el-table-column>
