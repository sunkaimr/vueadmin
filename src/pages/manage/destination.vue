<template>
  <imp-panel>
    ...
    <div slot="body">
      <el-dialog title="添加目标" :visible.sync="dialogAddFormVisible" :close-on-click-modal="false"
                 style="width: 100%;">
        <el-form size="mini" :model="form" :rules="rules" ref="form">
          ...
          <el-form-item label="归档介质" prop="storage" label-width="80px">
            <el-select v-model="form.storage" @change="storageChange" filterable placeholder="归档介质"
                       style="width: 100%;">
              <el-option
          ...
          <el-form-item label="目标库名" label-width="80px">
            <el-input v-model="form.database_name" placeholder="若不填默认和源库名保持一致"
                      autocomplete="off"></el-input>
          </el-form-item>
          <el-form-item label="目标表名" prop="table_name" label-width="80px">
            <el-input v-model="form.table_name"
                      placeholder="可指定名字，或引用源表如: {source_table}, {source_table}_{YYYY-MM}"
                      autocomplete="off"></el-input>
          </el-form-item>
      ...
      <el-dialog title="修改源端信息" :visible.sync="dialogEditFormVisible" :close-on-click-modal="false"
        ...
        <el-form size="mini" :model="form" :rules="rules" ref="form">
          ...
          <el-form-item label="目标库名" label-width="80px">
            <el-input v-model="form.database_name" disabled placeholder="若不填默认和源库名保持一致"
                      autocomplete="off"></el-input>
          </el-form-item>
          <el-form-item label="目标表名" prop="table_name" label-width="80px">
            <el-input v-model="form.table_name" disabled
                      placeholder="可自定义名字，或引用源表及日期如: {source_table}, {source_table}_{YYYY-MM}"
                      autocomplete="off"></el-input>
          </el-form-item>
          <el-form-item label="压缩存储" label-width="80px">
